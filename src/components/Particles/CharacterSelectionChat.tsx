...
import Yanami from "../../assets/img/chat-characters/Yanami.png";
import Lemon from "../../assets/img/chat-characters/Lemon.png";
import Komari from "../../assets/img/chat-characters/Komari.png";
...
export const SelectCharacter: React.FC<SelectCharacterProps> = ({
  ...
  return <MenuSelect items={items} className={mobileClassName} />;
};
